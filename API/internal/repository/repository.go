...
type Repository interface { //comunicaciones con la base de datos
	...
	SaveRoom(ctx context.Context, data []models.DataInfo, config map[string]interface{}, fosil map[string]interface{}, name string, facies map[string][]models.FaciesSection) error // Actualiza un proyecto en MongoDB
